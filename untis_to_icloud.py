...
def main():
    ...
    for uid,lesson in wanted.items():
        ...
        if uid in existing:
            ...
            if ics != old_data:
                existing[uid].data=ics; existing[uid].save(); updated+=1
        else:
